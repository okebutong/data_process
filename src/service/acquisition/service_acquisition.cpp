    ...
    : QObject{parent}
{
    ...
    connect(m_storage, &Storage::openError, this, &Acquisition::openErrorString);

    connect(m_commThread, &QThread::finished, m_commThread, &QObject::deleteLater);
...
Acquisition::~Acquisition()
{
    ...
    m_parseThread->wait();
    m_commThread->wait();
    MyLoggers::getLogger("DataParse")->info("Acquisition success destruct");
}
